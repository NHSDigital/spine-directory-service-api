...
CONFIG_PREFIX = "SDS"
CACHE_EXPIRY_TIME_KEY = "SDS_SDS_CACHE_EXPIRY_TIME"
DEFAULT_CACHE_EXPIRY_TIME = 900
CACHE_EXPIRY_TIME = 450
CACHE_HOST_KEY = "SDS_SDS_REDIS_CACHE_HOST"
CACHE_HOST = "localhost"
CACHE_PORT_KEY = "SDS_SDS_REDIS_CACHE_PORT"
CACHE_PORT = "6379"
CACHE_DISABLE_TLS_KEY = "SDS_SDS_REDIS_CACHE_PORT"
DISABLE_TLS = "True"
