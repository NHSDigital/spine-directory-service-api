...
INTERACTION_MAPPINGS = {
    FORWARD_RELIABLE_CORE_SPINE_SERVICE_INTERACTION: FORWARD_RELIABLE_INTERACTIONS,
    FORWARD_EXPRESS_CORE_SPINE_SERVICE_INTERACTION: FORWARD_EXPRESS_INTERACTIONS
}