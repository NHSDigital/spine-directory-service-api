...
async def get_device_from_cpm(org_code: str, interaction_id: str, manufacturing_organization: str = None, party_key: str = None) -> List:
    ...
    try:
        ...
        assert False, f"client_id, {client_id} : CPM_CLIENT_KEY, {os.environ['CPM_CLIENT_KEY']} : CPM_CLIENT_KEY_A, {os.environ['CPM_CLIENT_KEY_A']} : APIGEE_URL, {os.environ['APIGEE_URL']} : GP_CONNECT, {os.environ['GPC_CLIENT_ID']}"
